...
**Preview deployments:** If you push to another branch (or open a PR), Vercel creates a *preview* URL for that branch. Production (your main live URL) only changes when you push to `main`.
